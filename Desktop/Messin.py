...
p_R = GPIO.PWM(pins[0], 0.2)  # set Frequency to 2KHz		What does frequency do here? Possibly sets intensity? 
			       #PWM: Pulse Width Modulation (Frequency waves)
p_G = GPIO.PWM(pins[1], 0.2)  #Uses DMA (Direct Memory Access) for more precision and slower timing
